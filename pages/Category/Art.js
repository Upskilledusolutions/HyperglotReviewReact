...
import data1 from "@/pages/api/art";
  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className={styles.flexcontainer}>
          <div className={styles.left}>
            {featuredArt && <div className={styles.bigbox5}>
              <Image
              ...
              <Link
                ...
                href={`/SinglePage/${featuredArt[featuredArt.length - 1].id}?type=art`}>
                ...
                <div key={data.id} className={styles.listcontainer}>
                  ...
                  <div className={styles.listinfo}>
                    <Link
                      ...
                      href={`/SinglePage/${data.id}?type=art`}
                    >
                      <h3>{data.heading}</h3>
                    </Link>
      ...
      <div>
        ...
        <div className={styles.flexcontainer}>
          <div className={styles.left}>
            {emergingArt && <div className={styles.bigbox5}>
              <Image
                className={styles.img}
