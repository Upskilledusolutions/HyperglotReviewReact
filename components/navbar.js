...
const navbar = () => {
  ...
  return (
    <div  className={`${styles.navbar} ${router.pathname !== '/' ? styles.bgWhite : color ? styles.bg : styles.bgnone} ${show ? styles.display : styles.none}`}>

      <div>

       <Image className={styles.logo} src="/logo.jpg" width={400} height={400} alt="logo"/>
     
     </div>

     <div className={`${styles.nav} ${toggle ? styles.navActive : ''}`}>
      ...
      <ul>
        ...
        <li>
          <div className={styles.dropdown}>
            <div className={styles.dropflex} onClick={() => toggleDropdown(0)}>
            <Link className={styles.link} href='/Category/Art'>Art</Link>
            <FaAngleDown className={styles.downarrow}/>
            </div>
            <div className={styles.dropdowncontent} style={{ display: openDropdown === 0 ? 'block' : 'none' }}>
        ...
        <li>
          <div className={styles.dropdown}>
          <div className={styles.dropflex} onClick={() => toggleDropdown(1)}>
          <Link className={styles.link} href='/Category/Literature'>Literature</Link>
            <FaAngleDown className={styles.downarrow}/>
            </div>

            <div className={styles.dropdowncontent}  style={{ display: openDropdown === 1 ? 'block' : 'none' }}>
        ...
        <li>
          <div className={styles.dropdown}>
          <div className={styles.dropflex} onClick={() => toggleDropdown(2)}>
